...
<div class="row">
	...
	?>
	<form action="<?php echo base_url()?>index.php/kelurahan/insert_transaksi_keluar_pengepul" method="POST" enctype="multipart/form-data">
				<div class="col-md-6 col-sm-12 col-xs-12">
					<h3>Input Transaksi Keluar Pengepul</h3>
					<div class="panel panel-default">
					  <div class="panel-body form-horizontal payment-form">
							<div class="form-group">
								<label for="date" class="col-sm-3 control-label">Tanggal</label>
								<div class="col-sm-9">
									<input type="date" class="form-control" id="date" name="tanggal" required="true">
								</div>
							</div>  
							<div class="form-group">
								<label for="pengepul_form" class="col-sm-3 control-label">Dari Pengepulan</label>
								<div class="col-sm-9">
									<select class="form-control" id="pengepul_form" name="pengepul">
										<?php 
							...
							<div class="form-group">
								<label for="tujuan" class="col-sm-3 control-label">Tujuan Setor</label>
								<div class="col-sm-9">
...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
		<table class="table" id="table_id">
			...
			<?php
				$no = 1;
                foreach($transaksi_keluar->result() as $riwayat){
			?>
				<tr>
	                <td><?php echo $no++;?></td>
	                ...
	                <td><?php echo $riwayat->tujuan_setor?></td>
	                <td style="text-align: center;">
	                    ...
	                    <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete_modal" onclick='modal_hapus(<?php echo '"'.$riwayat->id_transaksi.'"';?>)'><i class="glyphicon glyphicon-trash"></i></button>
	                </td>
	            </tr>
	           <?php }?>
		</tbody>
...
<script type="text/javascript">
	...
	function edit(id_transaksi) {
	    ...
	    xmlhttp.open("GET", "<?php echo base_url()?>/index.php/proses_db/edit_ajax_ts_keluar?"+param, true);
	...
	function hapus(){
		...
		var xmlhttp=new XMLHttpRequest();
	    var param="kode="+id_transaksi;
	    xmlhttp.open("GET", "<?php echo base_url()?>/index.php/proses_db/hapus_ajax_ts_keluar?"+param, true);
	    xmlhttp.onreadystatechange=function(){
	   	if(this.readyState == 4 && this.status == 200){
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel"><span class="glyphicon glyphicon-pencil"></span> Edit Transaksi Keluar Pengepul</h4>
