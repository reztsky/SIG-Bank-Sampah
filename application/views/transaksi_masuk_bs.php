...
<div class="row">
	...
	?>
	<form action="<?php echo base_url()?>index.php/kelurahan/insert_transaksi_bs" method="POST" enctype="multipart/form-data">
		<div class="col-md-6 col-sm-12 col-xs-12">
			<h3>Input Transaksi Masuk Bank Sampah</h3>
			<div class="panel panel-default">
			  <div class="panel-body form-horizontal payment-form">
					...
					<div class="form-group">
						<label for="bank_sampah" class="col-sm-3 control-label">Pilih Bank Sampah</label>
						<div class="col-sm-9">
	...
	<div class="col-md-12 col-sm-12 col-xs-12 table-responsive">
		<table class="table" id="table_id">
			...
			<tbody id="tbody_riwayat">
				<?php 
					$no=1;
					foreach($transaksi_masuk_bs->result() as $row){?>
					<tr>
						<td><?php echo $no?></td>
...
<script type="text/javascript">
	...
	function edit(id_transaksi) {
	    ...
	    xmlhttp.open("GET", "<?php echo base_url()?>/index.php/proses_db/edit_ajax_ts_masuk_bs?"+param, true);
	...
	function hapus(){
		...
		var xmlhttp=new XMLHttpRequest();
	    var param="kode="+id_transaksi;
	    xmlhttp.open("GET", "<?php echo base_url()?>/index.php/proses_db/hapus_ajax_ts_masuk_bs?"+param, true);
	    xmlhttp.onreadystatechange=function(){
	   	if(this.readyState == 4 && this.status == 200){
