	...
	<div class="col-md-12 col-xs-12 col-sm-12">
		<div class="form-group">
			<div class="row">
				...
				<div class="col-md-12 col-xs-12 col-sm-12">
					<button style="margin-left: 1.3%;" class="btn btn-primary" onclick="" id="filter">Filter</button>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12 col-xs-12 col-sm-12 table-responsive">
				<h3>Rekap</h3>
				<a id="download" href="<?php echo base_url()?>/index.php/c_admin/rekap_transaksi_masuk_pengepul_excel">Download Excel</a>
				<div id="isiTab">
...
<script type="text/javascript">
	$.noConflict();
      jQuery( document ).ready(function( $ ) {
        ...
        $('#download').attr('href','<?php echo base_url()?>/index.php/c_admin/rekap_transaksi_masuk_pengepul_excel?data='+json_tab);
			        ...
			        var param="periode="+periode+"&tanggal_akhir="+tanggal_akhir+"&tanggal_dari="+tanggal_dari+"&jenis_sampah="+jenis_sampah;
			         <?php 
			          if($this->session->userdata('level')!='admin'){
			            echo 'xmlhttp.open("POST", "'.base_url().'/index.php/proses_db/rekap_ts_keluar_table_pengepul", true);';
			          }else{
			            echo 'xmlhttp.open("POST", "'.base_url().'/index.php/proses_db/rekap_ts_keluar_table_pengepul", true);';
			          }
			        ?>
			        ...
			        xmlhttp.onreadystatechange=function(){
			          if(this.readyState == 4 && this.status == 200){
        				...
        				var json=JSON.stringify(arr);
			           	$('#download').attr('href','<?php echo base_url()?>/index.php/c_admin/rekap_transaksi_masuk_pengepul_excel?data='+json);
